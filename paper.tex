...
\begin{figure}[!h]
\centering
\subfloat[initial path]{\includegraphics[width=0.38\linewidth]{figure/1.jpg}} \qquad
\subfloat[result path]{\includegraphics[width=0.38\linewidth]{figure/2.jpg}} \\
...
\begin{figure}[!h]
\centering
\subfloat[]{\includegraphics[width=0.42\linewidth]{figure/penetration_encode.pdf}} \qquad
\subfloat[]{\includegraphics[width=0.38\linewidth]{figure/discrete_directions.pdf}}
...
\begin{figure*}[t]
\centering
\subfloat[jagged-dubin]{\includegraphics[width=0.26\linewidth]{figure/benchmark/jagged_dubins.jpg}} \qquad
\subfloat[gap-dubin]{\includegraphics[width=0.21\linewidth]{figure/benchmark/cargap_dubins.jpg}} \qquad
\subfloat[squared-dubin]{\includegraphics[width=0.22\linewidth]{figure/benchmark/squared_dubins.jpg}}
...
\begin{figure*}[t]
\centering
\subfloat[bookshelf]{\includegraphics[width=0.12\linewidth]{figure/benchmark/bookshelves.jpg}} \qquad
\subfloat[skew-bookshelf]{\includegraphics[width=0.12\linewidth]{figure/benchmark/bookshelves_rotate.jpg}} \qquad
\subfloat[countertop]{\includegraphics[width=0.16\linewidth]{figure/benchmark/countertop.jpg}} \qquad
\subfloat[industrial]{\includegraphics[width=0.16\linewidth]{figure/benchmark/industrial.jpg}} \qquad
\subfloat[industrial2]{\includegraphics[width=0.14\linewidth]{figure/benchmark/industrial2.jpg}}
...
\begin{figure*}[t]
\centering
\subfloat[hotel]{\includegraphics[width=0.28\linewidth]{figure/benchmark/hotel.jpg}} \qquad
\subfloat[kitchen]{\includegraphics[width=0.26\linewidth]{figure/benchmark/kitchen10.jpg}} \\
\subfloat[kitchen2]{\includegraphics[width=0.19\linewidth]{figure/benchmark/kitchen.jpg}} \qquad
\subfloat[livingroom]{\includegraphics[width=0.19\linewidth]{figure/benchmark/livingroom.jpg}} \qquad
\subfloat[livingroom2]{\includegraphics[width=0.24\linewidth]{figure/benchmark/livingroom2.jpg}}
